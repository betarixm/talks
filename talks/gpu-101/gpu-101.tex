...
\begin{frame}{Richer materials needed programmable hardware}
  ...
  \note{윗줄은 고정 기능 GPU의 주요 처리 순서입니다. 정점의 위치와 조명을 계산하고, rasterizer가 삼각형을 화면의 조각으로 펼칩니다. 텍스처를 조합하고 안개 효과를 적용한 뒤, 깊이 검사와 색 혼합을 거쳐 프레임버퍼에 기록합니다. 초기 OpenGL은 조명과 재질 같은 설정으로 준비된 연산을 제어했습니다.
